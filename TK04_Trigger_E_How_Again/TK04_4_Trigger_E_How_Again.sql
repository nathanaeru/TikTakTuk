CREATE OR REPLACE FUNCTION check_order_promotion_func() 
RETURNS TRIGGER AS $$
DECLARE
...
BEGIN
    ...
    -- Validasi tanggal event dengan promo (mengambil tanggal event dari Order dan Ticket Category terkait) 
...
FOR EACH ROW EXECUTE FUNCTION check_order_promotion_func();